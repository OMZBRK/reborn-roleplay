...
public final class SpeechBubbles {
    ...
    public static void render(GuiGraphicsExtractor ctx) {
        ...
        Set<Integer> speaking = VoiceState.speakingEntityIds();
        ...
        for (int id : speaking) {
            ...
            if (e == null || e == mc.player) continue;      // pas de bulle sur soi
            double dist = e.position().distanceTo(camPos);
            if (dist > MAX_DIST) continue;

            // Point juste au-dessus de la tête.
            ...
            if (clip.w() <= 0.05f) continue;                // derrière la caméra
