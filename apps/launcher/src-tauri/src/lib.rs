...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            content::whitelist_oral_slots,
            content::whitelist_book_slot,
            content::whitelist_cancel_slot,
            content::whitelist_reclaim,
