...
import { Download, Share2, Star, Trash2, User } from "lucide-react";
...
export function ScreenshotThumb({ shot, layout, onOpen }: Props) {
  if (layout === "list") {
    return (
      <button
        type="button"
      ...
      <div className="reborn-shots-detail-card">
        ...
        <div className="reborn-shots-detail-body">
          ...
          <div className="reborn-shots-detail-actions">
            <button type="button" className="reborn-shots-action-btn">
  ...
  return (
    ...
    >
      <span
        className="reborn-shots-thumb-art"
        style={{ background: shot.art }}
      />
      <span className="reborn-shots-thumb-server">{shot.server}</span>
      {shot.pinned && (
        <span className="reborn-shots-thumb-pin">
